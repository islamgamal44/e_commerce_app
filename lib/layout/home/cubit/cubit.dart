...
import 'package:shop_app/modules/shop_modules/categories/categories_screen.dart';
import 'package:shop_app/modules/shop_modules/favourites/favourites_screen.dart';
import 'package:shop_app/modules/shop_modules/products/products_screen.dart';
...
class HomeCubit extends Cubit<HomeStates>{
  ...
  void getHomeData(){
    ...
    DioHelper.getData(path: home,token: token.toString())
      ...
      print('home Model : ${homeModel!.data}');
